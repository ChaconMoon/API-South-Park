...
This Module define the tests to the responses in random episode endpoint.
"""
...
def test_episode_database_correct():
    ...
    with patch(
        ...
        response = client.get("/api/episodes/random")
...
def test_random_episode_database_not_avalible():
